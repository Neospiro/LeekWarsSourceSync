...
LW.login = function( login, password, callback ){
  console.log( "[LOGIN] " + login + "/"+'********************************'.substr(1,password.length) );
...
LW.lang = {} ;
  ...
  LW.lang.get = function ( file, callback ){
    //console.log('[LANG] Récupération codes erreurs fr');
